...
Our goal is to provide and simple and easy standard interface for monitoring and publishing application metrics in Java.  Both in "Amazon":http://aws.amazon.com, other clouds and private data centers. This has already been implemented inside of Netflix and most of our applications currently use it.
